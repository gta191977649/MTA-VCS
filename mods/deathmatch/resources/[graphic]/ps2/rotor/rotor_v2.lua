...
local renderList = {}
local rotor_txd = dxCreateTexture("rotor/model/black64aa.dds", "argb", true, "clamp")
-- better way of handling that use shader
function applyHeliRotorFix(heli)
    --create shader
    renderList[heli] = {}
    renderList[heli].shader = dxCreateShader("rotor/rotor.fx")
    ...
    engineApplyShaderToWorldTexture(renderList[heli].shader, "rustler92prop64*",heli)
