//
// warpedSiveWave.fx
// http://glslsandbox.com/e#26939.0
...
{   
    ...
    float t = abs( 1.0 / (sin( position.y + sin( timer + position.x * 10.0 ) * position.x ) * 10.0) );
    float3 finalColor = float3( t * 0.1, t * 0.1, t * 0.8 );
