//
// weirdFlower.fx
// http://glslsandbox.com/e#22495.0
...
{  
    ...
    float b=abs(length(position)-0.5)+(sin(31.*(atan2(position.x,position.y)+timer)))*0.13;

    return float4(b,abs(.5-b),1.-b, 1. );
}

//------------------------------------------------------------------------------------------
// Techniques
//------------------------------------------------------------------------------------------
technique weirdFlower
{
    pass P0
    {
