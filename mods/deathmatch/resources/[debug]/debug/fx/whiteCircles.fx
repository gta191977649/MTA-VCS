//
// whiteCircles.fx
// http://glslsandbox.com/e#28649.0
...
// PixelShaderFunction
//------------------------------------------------------------------------------------------
float rings(float2 p, float timer)
{
    return sin(length(p)*64.0 - timer * 10.0);
}
...
{	
    ...
    float color = rings(position,timer);
